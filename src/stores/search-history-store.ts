...
// Port of the webmail's stores/search-history-store.ts: only the raw text
// queries are kept (never filter panel state), most recent first,
// deduplicated, and capped so the dropdown stays scannable.
